...
class InputLoader(object):
    ...
    def setup_ui(self):
        ...
        if self.src in [opmod.plugin_input,opmod.fs_input]:
        ...
        elif self.src in [opmod.plugin_input,opmod.wf_input]:
            self.ui.source_treeview.hideColumn(2)
            self.ui.source_treeview.setColumnWidth(0,250)
            self.tree_model().set_all_flagged('select',False)
        if self.src == opmod.plugin_input:
        ...
        elif self.src in [opmod.wf_input,opmod.plugin_input,opmod.fs_input]:
