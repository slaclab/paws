...
def start_save_ui(parent,fspath=None):
    ...
    save_ui.tree_box.setTitle('Select or enter a .wfl file in which to save paws objects')
...
def start_load_ui(parent,fspath=None):
    ...
    trmod = QtGui.QFileSystemModel()
    trmod.setNameFilters(['*.wfl'])
    load_ui.tree_box.setTitle('Select a .wfl file from which to load paws objects')
