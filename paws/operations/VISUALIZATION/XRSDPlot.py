...
class XRSDPlot(Operation):
    ...
    alongside the total scattering intensity of the system,
    on top of whatever input `q_I` data are provided.
    """
    ...
    def __init__(self):
        ...
        # NOTE: removed figure from outputs because it cannot be copied
