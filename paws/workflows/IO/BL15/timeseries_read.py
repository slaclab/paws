...
wfmgr.load_operations('batch_read',
    ...
    t_populations='PACKAGING.BATCH.XYDataFromBatch'
    )
...
wf.connect('batch.outputs.batch_outputs',[\
    ...
    't_populations.inputs.batch_outputs'])
...
wf.set_op_inputs('t_populations',x_key='time',y_key='populations',x_sort_flag=True,x_shift_flag=True)
