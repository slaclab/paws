...
wf.connect_input('populations_file','check_pops_file.inputs.file_path')
wf.connect('check_pops_file.inputs.file_path',[\
    'conditional_read.inputs.inputs.file_path',\
    'save_fit.inputs.file_path'])
wf.connect_output('populations_file','check_pops_file.inputs.file_path')
...
wf.set_op_inputs('populations_switch',truth_condition=True,else_data={'unidentified':{'structure':'unidentified'}})
...
wfmgr.save_to_wfl('read_and_fit',os.path.join(pawstools.sourcedir,'workflows','FITTING','BL15','conditional_read_and_fit.wfl'))
