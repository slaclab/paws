...
paw.activate_op('IO.BL15.ReadImageAndHeader_SSRL15')
...
paw.set_input('background_batch','input_keys',['image_file'])
...
paw.set_input('sample_files','regex','*.tif')
paw.set_input('sample_files','new_files_only',False)
...
paw.set_input('sample_realtime','input_keys',['image_file'])
...
paw.add_op('read_image','IO.BL15.ReadImageAndHeader_SSRL15')
...
# path to image file
paw.add_wf_input('image_file','read_image.inputs.file_path')
...
paw.set_input('time_temp','image_header','read_image.outputs.image_header','workflow item')
