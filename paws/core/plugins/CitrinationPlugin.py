...
class CitrinationPlugin(PawsPlugin):
    ...
    def __init__(self):
        ...
        self.input_src['address'] = opmod.text_input
        self.input_src['api_key_file'] = opmod.fs_input
        self.input_type['address'] = opmod.str_type
        self.input_type['api_key_file'] = opmod.path_type
