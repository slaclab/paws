...
class PifTernary(Operation):
    ...
    def __init__(self):
        ...
        self.input_src['q_texture'] = opmod.wf_input
        self.input_src['I_features'] = opmod.wf_input
        self.input_src['pk_idx'] = opmod.wf_input
        ...
        self.input_type['q_texture'] = opmod.ref_type
        self.input_type['I_features'] = opmod.ref_type
        self.input_type['pk_idx'] = opmod.ref_type
