...
class BatchFromFiles(Batch):
    ...
    def __init__(self):
        ...
        self.input_doc['downstream_ops'] = 'list of operation uris to be included in batch execution'
    ...
    def downstream_ops(self):
        """Use Batch.downstream_ops to list uri's of ops to be included in batch execution"""
